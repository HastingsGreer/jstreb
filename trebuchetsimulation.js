...
export function calculateRange(trajectories, data, constraintLog) {
  ...
  for (var constraint of lastConstraints) {
    ...
    if (constraint.name === "Rope") {
      for (var pulley of constraint.pulleys) {
